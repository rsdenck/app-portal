    ...
    <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:20px;flex-wrap:wrap;gap:15px">
        <form method="GET" style="display:flex;gap:10px;flex:1;min-width:300px;flex-wrap:wrap">
            ...
            <?php if ($search || $typeFilter || $clientFilter): ?>
                <a href="/atendente_ativos.php" class="btn">Limpar</a>
            <?php endif; ?>
        </form>
                ...
                <tbody>
                    <?php foreach ($assets as $asset): ?>
                        <tr>
                            ...
                            <td>
                                <div style="font-size:13px"><?= h($asset['client_company'] ?: $asset['client_name']) ?></div>
                            </td>
            ...
            <div id="tab-rede" class="tab-content">
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:15px">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="subnet_mask" class="input">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="mac_address" class="input">
                    </div>
                    <div class="form-group">
