...
render_header('Atendente · Fila', current_user());
?>
<div class="card">
  ...
  <table class="table">
    ...
    <tbody>
      <?php if (!$tickets): ?>
        <tr><td colspan="7" class="muted">Nenhum chamado atribuído.</td></tr>
      <?php endif; ?>
      <?php foreach ($tickets as $t): ?>
        ...
        ?>
        <tr <?= $m['sla_status'] === 'Atrasado' ? 'style="background: rgba(255,0,0,0.05)"' : '' ?>>
          <td>
          ...
          <td style="display:flex;gap:8px;flex-wrap:wrap">
            <a class="btn primary" href="/atendente_ticket.php?id=<?= (int)$t['id'] ?>">Visualizar</a>
          </td>
        </tr>
      <?php endforeach; ?>
    </tbody>
