...
if (!$projectId) {
    redirect('/atendente_projetos.php');
}
...
<div class="project-view-header">
    <div style="display:flex;align-items:center;gap:12px">
        <a href="/atendente_projetos.php" class="btn" style="padding: 4px 8px;">
                ...
                <tbody>
                    <?php foreach ($group['items'] as $item): ?>
                        <tr data-item-id="<?= (int)$item['id'] ?>">
                            ...
                            <td>
                                <div class="status-cell status-<?= strtolower(str_replace(' ', '-', (string)$item['status'])) ?>" onclick="toggleStatus(this)">
