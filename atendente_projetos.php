        ...
        <?php foreach ($projects as $project): ?>
            <div class="project-card">
                <div class="project-card-header">
                    ...
                    <div class="project-status-tag active">Ativo</div>
                </div>
                ...
                <div style="margin-top:auto;padding-top:12px">
                    <a href="/atendente_projeto_view.php?id=<?= (int)$project['id'] ?>" class="btn" style="width:100%;text-align:center">Gerenciar</a>
                </div>
            </div>
        <?php endforeach; ?>
