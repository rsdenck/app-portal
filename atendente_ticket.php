        ...
        <div class="col" style="flex:1">
            <div class="card" style="border:1px solid var(--border);padding:15px;border-radius:4px">
                ...
                <div style="display:flex;flex-direction:column;gap:10px">
                    <a class="btn" href="/atendente_transfere.php?ticket_id=<?= (int)$ticket['id'] ?>" style="text-align:center">Transferir Chamado</a>
                    <a class="btn danger" href="/atendente_encerrar.php?ticket_id=<?= (int)$ticket['id'] ?>" style="text-align:center">Encerrar Chamado</a>
                </div>
            </div>
