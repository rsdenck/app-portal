...
<div class="card">
  <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:12px">
    ...
    <a class="btn primary" href="/tk_cliente.php?action=create">Novo cliente</a>
  </div>
  ...
  <?php if ($action === 'create' || ($action === 'update' && $editingClient)): ?>
    ...
    <form method="post" style="margin-bottom:18px">
      ...
      <div style="margin-top:14px;display:flex;gap:10px;flex-wrap:wrap">
        ...
        <a class="btn" href="/tk_cliente.php">Cancelar</a>
      </div>
    </form>
  <?php endif; ?>
  <table class="table">
      ...
      <?php foreach ($clients as $c): ?>
        ...
        <tr>
          ...
          <td style="display:flex;gap:8px;flex-wrap:wrap">
            <a class="btn" href="/tk_cliente.php?action=update&id=<?= (int)$c['id'] ?>">Editar</a>
