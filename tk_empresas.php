...
<div class="card">
  <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:12px">
    ...
    <a class="btn primary" href="/tk_empresas.php?action=create">Nova empresa</a>
  </div>
  ...
  <?php if ($action === 'create' || ($action === 'update' && $editingCompany)): ?>
    ...
    <form method="post" style="margin-bottom:18px">
      ...
      <div style="margin-top:14px;display:flex;gap:10px;flex-wrap:wrap">
        ...
        <a class="btn" href="/tk_empresas.php">Cancelar</a>
      </div>
    </form>
  <?php endif; ?>
  <table class="table">
      ...
      <?php foreach ($companies as $c): ?>
        ...
        <tr>
          ...
          <td style="display:flex;gap:8px;flex-wrap:wrap">
            <a class="btn" href="/tk_empresas.php?action=update&id=<?= (int)$c['id'] ?>">Editar</a>
